...
public class ElectricBills extends Activity {
...
//    String username , accountID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.electric_bill);

        accountIDEdit = (EditText) findViewById(R.id.accountIDBill2);
        result = (TextView) findViewById(R.id.result2);
        viewResult = (Button)findViewById(R.id.viewResult2);
    ...
    public  static HttpsURLConnection getServerConnection() throws Exception{
        URL url = new URL("http://localhost:8080/swagger-ui.html#!/electric-bills-controller/ElectricBillsUsingGET");
